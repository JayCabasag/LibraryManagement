...
import { ALGOLIA_SEARCH_API_KEY, ALGOLIA_SEARCH_APP_ID, ALGOLIA_SEARCH_URL, IMAGES } from '../../utils/app_constants'
...
const Books = () => {
  ...
  const searchBooks = async (value: string) => {
    ...
    const url = `${ALGOLIA_SEARCH_URL}${value}&hitsPerPage=${maxBookResultsLimit}&getRankingInfo=1`;
